...
//Generates a number of pAequor organism(s) that has 60% survival rate
const pAequorThatCanSurvive = numOfpAequors => {
  const survivedPAequor = [];
  let i = 0;
  while (survivedPAequor.length < numOfpAequors) {
...
// console.log(pAequorThatCanSurvive(30));
